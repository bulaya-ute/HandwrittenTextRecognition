...
if not os.path.exists(dataset_path):
    print("'Datasets/IAM_Words' doesn't exist")
...
# Loading the model
model = tf.keras.models.load_model("handwritten_text_detection_model.h5")
...
# Save model
print("Saving model...")
model.save(r"handwritten_text_detection_model.h5")
print("Model saved!")
